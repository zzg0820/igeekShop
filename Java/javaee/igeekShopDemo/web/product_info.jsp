...
<body>
	...
	<div class="container">
		<div class="row">
			<c:if test="${not empty proById}">
			<div
				style="border: 1px solid #e4e4e4; width: 930px; margin-bottom: 10px; margin: 0 auto; padding: 10px; margin-bottom: 10px;">
				<a href="index.do">首页&nbsp;&nbsp;&gt;</a> <a href="./蔬菜分类.htm">${proById.cName}</a>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					<div>
						<strong>${proById.pName}</strong>
					</div>
					<div
						style="border-bottom: 1px dotted #dddddd; width: 350px; margin: 10px 0 10px 0;">
						<div>编号：<span id="proId">${proById.pId}</span></div>
					</div>

					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${proById.shop_price}元/份</strong> 参 考 价：
						<del>￥${proById.market_price}元/份</del>
					</div>
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a> <input
								...
								value="加入购物车" type="button" id="addCart">
							</a> &nbsp;收藏商品
						</div>
						<div class="msg">
