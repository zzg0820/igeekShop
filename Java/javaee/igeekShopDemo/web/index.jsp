		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProList}" var="hotPro" varStatus="p">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0;overflow:hidden;white-space: nowrap;text-overflow: ellipsis">
							<a href="proInfo.do?pid=${hotPro.pId}">
								<img src=${hotPro.pImage} width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="proInfo.do?pid=${hotPro.pId}" style='color:#666'>${hotPro.pName}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProList}" var="newPro" varStatus="p">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0;">
							<a href="proInfo.do?pid=${newPro.pId}">
								<img src=${newPro.pImage} width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="proInfo.do?pid=${newPro.pId}" style='color:#666;overflow:hidden;white-space: nowrap;text-overflow: ellipsis'>${newPro.pName}</a></p>
